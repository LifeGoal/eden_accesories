...
AddEventHandler('eden_accesories:silencieux', function(duration)
	...
	used = used + 1
		  		  ...
		  		  ESX.ShowNotification(("You do not have a weapon in hand or your weapon does not support a silencer."))
		  		
			end
			else
					  		 ESX.ShowNotification(("You have used all of your silencers, buy another one or un-equip your used silencers.")) 
...
AddEventHandler('eden_accesories:grip', function(duration)
	...
	used3 = used3 + 1
		  		  ...
		  		  ESX.ShowNotification(("You do not have a weapon in hand or your weapon does not support a grip."))
		  		
			end
			else
					  		 ESX.ShowNotification(("You have used all of your grips, buy another one or un-equip your used grips.")) 
		end
end)
...
AddEventHandler('eden_accesories:yusuf', function(duration)
    ...
    local currentWeaponHash = GetSelectedPedWeapon(ped)
		if used4 < yusuf then
			...
			if currentWeaponHash == GetHashKey("WEAPON_PISTOL") then
		  		 ...
		  		 ESX.ShowNotification(("You have just equipped yourself with a Deluxe Skin. It will be necessary to re-equip it with every return in town.")) 
		  		 	used4 = used4 + 1
	...
	used4 = used4 + 1
		  		  ...
		  		  ESX.ShowNotification(("You do not have a weapon in hand or your weapon does not support a skin."))
		  		
			end
			else
					  		 ESX.ShowNotification(("You have used all of your skins, buy another one or un-equip your used skins.")) 
